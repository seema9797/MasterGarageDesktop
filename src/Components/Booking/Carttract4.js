...
const Carttrack4 = () => {
    return (
        <Container fluid>
            <Row className='p-5'>
               <div>
             <Link to ="/Carttrack3" className="bookawait"><i className='fa fa-arrow-left'></i></Link>
             <Link to="/Carttrack3" className="bookawait1">Tracking Status</Link>
             </div>
            <Col lg={8}>
            <Track/>
            </Col>
                        ...
                        <div class="step">
                          ...
                          <img src={carttrack55} alt="error"/>
                            ...
                            <ul className="eventstepp">
                              ...
                              <Link to="#"><li className="first1">Vehicle Ready</li></Link>
                              <li>Payment</li>
                            </ul>
                        </div>
                      </CardBody>
                              <div className="payfooter12">
                                  ...
                                  <div>
                                     <Link to="/Carttrack5"> <button className="totalbtn1">Pay now</button></Link>
                                  </div>
                              </div>
...
export default withRouter(Carttrack4)
