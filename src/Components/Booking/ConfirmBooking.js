...
const Booking1 = () => {
    return (
        <Container fluid>
            <Row className='p-5'>
            <div>
             <Link to ="/booking1" className="bookawait"><i className='fa fa-arrow-left'></i></Link>
             <Link to="/booking1" className="bookawait1">Tracking Status</Link>
             </div>
                        ...
                        <div class="step">
                          ...
                          <img src={carttrack55} alt="error"/>
                            ...
                            <ul className="eventstepp">
                             <Link to="#"> <li className="first">Vehicle Received</li></Link>
                              ...
                              <div className="payfooter12">
                                  ...
                                  <div>
                                     <Link to="/CartTrack2"> <button className="totalbtn1">Pay now</button></Link>
                                  </div>
                              </div>
