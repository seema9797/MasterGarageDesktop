...
const CartTrack2 = () => {
    return (
        <Container fluid>
            <Row className='p-5'>
               <div>
             <Link to ="/confirmbooking" className="bookawait"><i className='fa fa-arrow-left'></i></Link>
             <Link to="/confirmbooking" className="bookawait1">Tracking Status</Link>
             </div>
                        ...
                        <div class="step">
                          ...
                          <img src={carttrack55} alt="error"/>
                            ...
                            <ul className="eventstepp">
                              ...
                              <Link to="#"><li className="first1">Diagnosed by Garage</li></Link>
                              ...
                              <div className="payfooter12">
                                  ...
                                  <div>
                                     <Link to="/CartTrack3"> <button className="totalbtn1">Pay now</button></Link>
                                  </div>
                              </div>
...
export default withRouter(CartTrack2)
