...
const Bookinghistorycard = ({bookid,bookdate,booktime,totalbook,bookdetail,rate}) => {
  return (
    <Card>
    <div className="mainongoincont p-3">
        <div>
            <div className="ongoingheader113">
                <div className="bookdetails">
                    <small>Bookin ID</small>
                    <p>{bookid}</p>
                </div>
                <div className="bookdetails212">
                ...
                <div className="bookdetails212">
                    ...
                    <p className="ratehistorybook"><svg id="Group_19003" data-name="Group 19003" xmlns="http://www.w3.org/2000/svg" width="156.027" height="19.124" viewBox="0 0 156.027 19.124">
            ...
            <small>review</small></p>
                </div>
            </div>
            <div className='ongoingheader113'>
                <div className="bookdetails214">
                  <small>Total Payment</small>
                  <p className="historybookcheck">{totalbook}<i class="fas fa-check-circle"></i></p>
                </div>
                <div className="bookdetails213">
                <small>Booking Details</small>
                  <p>{bookdetail}</p>
                </div>
                <div className="bookdetails_214">
