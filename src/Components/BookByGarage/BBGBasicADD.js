...
<Row>
    <Col sm={1} style={{width:'3%'}}><svg xmlns="http://www.w3.org/2000/svg" width="20.667" height="20.143" viewBox="0 0 20.667 20.143">
...
const BookADDPartTwo = () =>(
 ...
 Scheduled Service Packages</p>
        ...
        <Row className='Re_PartTwoBgBox p-2 my-2'>
         ...
         <Col sm={9} >
            ...
            <Col sm={3}>
                ...
                <button className='Partcaradded'>ADDED</button>
                </div>
         ...
         <hr></hr>
         <Row>
         <p className='poppins15blue'>What's Included</p>
                <ul className='ShowMoreServices'>
                    <li><p className='poppins15light'><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" style={{marginRight:'10px'}} viewBox="0 0 15 15">
...
const BookADDPartThree = () => (
    <>
        <div className='Re2_PartThreeBgBox py-1'>
            
            <Row className='px-3'>
                <Col sm={7}>
                    <p className='poppins18bold'>MH 04 AB 1234  <Link to=""> <span style={{fontSize:'16px',fontWeight:'500',paddingLeft:'10px'}}> Change</span></Link></p>
                    <p className='poppins15light' style={{paddingLeft:'10px'}}>Maruti Suzuki XL6</p>
                    <Row>
                    <Col sm={5}><img src={Fastaglogo} style={{width:'84px',height:'18px'}}></img></Col>
                    <Col sm={7}><span className='poppins15'>Balance : </span><span className='OpenSans15'>&#8377;459</span></Col>
                </Row>
                </Col>
                <Col sm={5}><img src={XL6} style={{width:'145px',height:'99px'}}></img></Col>
            </Row>
            <div className='px-3 py-2' style={{backgroundColor:'#4EE59D',width:'420px'}}>
                <Row>
                  <Col sm={6}><p className='poppins18bold'>Cart</p></Col>
                  <Col sm={6}  className='poppins18' style={{textAlign:'right'}}><p>8 Items</p></Col>
                  </Row> 
            </div>
